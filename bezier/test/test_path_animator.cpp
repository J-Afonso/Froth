...
TEST(TEST_BEZIER_ANIMATOR, test_bezier_animator) {
  ...
  start_1.handle_b = Vector3f(-0.8, -1, 0);
  start.Add(start_1);

  BezierPoint start_2;
  start_2.point = Vector3f(0, 1, 0);
  start_2.handle_a = Vector3f(-0.2, 1, 0);
  start_2.handle_b = Vector3f(0.2, 1, 0);
  start.Add(start_2);

  BezierPoint start_3;
  start_3.point = Vector3f(1, -1, 0);
  start_3.handle_a = Vector3f(0.8, -1, 0);
  start.Add(start_3);
  ...
  end_1.handle_a = Vector3f(-0.8, 1, 0);
  end.Add(end_1);

  BezierPoint end_2;
  end_2.point = Vector3f(0, -1, 0);
  end_2.handle_a = Vector3f(-0.2, -1, 0);
  end_2.handle_b = Vector3f(0.2, -1, 0);
  end.Add(end_2);

  BezierPoint end_3;
  end_3.point = Vector3f(1, 1, 0);
  end_3.handle_a = Vector3f(0.8, 1, 0);
  end.Add(end_3);
  ...
  EXPECT_EIGEN_EQ(start_2.point, initial_path.Get(0.5), kEigenTolerance);
